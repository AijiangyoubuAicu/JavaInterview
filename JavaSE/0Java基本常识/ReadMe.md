...
跨平台原理：由于各种操作系统所支持的指令集不是完全一致的，所以在操作系统之上加上一个虚拟机就可以提供同意的接口，屏蔽
操作系统之间的差异
...
更加高级的运算：
- [Math数学运算类](../2Java运算与控制流程/4.Math数学运算类/README.md) 该类提供初等数学的便利方法
...
- 抽象：只关注对象的属性和行为，不关心实现的细节
- 封装：隐藏一切可以隐藏的细节，只向外提供最简单的编程接口
